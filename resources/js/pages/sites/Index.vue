...
const deleteSubmit = (e: Event, id: string) => {
    ...
    formDelete.delete(route('sites.destroy', id), {
        preserveScroll: true,
            ...
            <div class="flex justify-between">
                <form @submit.prevent="submit">
                    <div class="flex gap-1">
                        ...
                        <Button v-if="props.params.search" as="a" :href="route('sites.index')" variant="destructive">Batal</Button>
                    </div>
                </form>
                    ...
                    <TableRow v-if="data.data.length > 0" v-for="(item, index) in data.data">
                        ...
                        <TableCell class="text-right">
                            <div class="flex justify-end gap-2">
                                <Button as="a" variant="outline" :href="route('sites.show', { id: item.id })">
                                    <span class="hidden sm:block">Detail</span>
                                </Button>
                                <ButtonEdit :href="route('sites.edit', { id: item.id })">
